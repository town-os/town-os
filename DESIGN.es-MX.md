...
Las pruebas de regresión son `TestWriteConfigReplacesConfigNewerThanTheBinary` y `TestWriteConfigAddsSectionsMissingFromAnOlderRendering` (unitarias), y `TestUpgradedControllerOpensRolodexMetricsListener` (de integración), que planta una configuración anterior a `9689461` con un mtime futuro, la reconcilia por el punto de entrada del arranque y recolecta el listener que abre entonces un contenedor real de rolodex.
