...
var ukUAMessages = map[string]string{ //nolint:gosec // G101 -- map keys are message IDs, not credentials
	...
	MsgAuthSessionNotOwned:          "цей обліковий запис може відкликати лише власні сеанси",
	...
	MsgGfehNotConfigured:         "об'єктне сховище не налаштоване",
	MsgGfehNameRequired:          "поле імені обов'язкове",
	MsgGfehPartitionExists:       "розділ уже існує",
	MsgGfehPartitionNotFound:     "розділ не знайдено",
	MsgGfehNetworkRequired:       "поле мережі обов'язкове",
	...
	MsgAuditAddGfehPrincipal:     "додати користувача об'єктного сховища",
	MsgAuditRemoveGfehPrincipal:  "вилучити користувача об'єктного сховища",
