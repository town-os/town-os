...
var fiFIMessages = map[string]string{ //nolint:gosec // G101 -- map keys are message IDs, not credentials
	...
	MsgAuthSessionNotOwned:          "tämä tili voi kumota vain omat istuntonsa",
	...
	MsgGfehNotConfigured:         "objektitallennusta ei ole määritetty",
	MsgGfehNameRequired:          "nimikenttä vaaditaan",
	MsgGfehPartitionExists:       "osio on jo olemassa",
	MsgGfehPartitionNotFound:     "osiota ei löytynyt",
	MsgGfehNetworkRequired:       "verkkokenttä vaaditaan",
	...
	MsgAuditAddGfehPrincipal:     "lisää objektitallennuksen käyttäjä",
	MsgAuditRemoveGfehPrincipal:  "poista objektitallennuksen käyttäjä",
