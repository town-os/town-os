...
var itITMessages = map[string]string{
	...
	MsgAuthSessionNotOwned:          "questo account può revocare solo le proprie sessioni",
	...
	MsgGfehNotConfigured:         "l'archiviazione a oggetti non è configurata",
	MsgGfehNameRequired:          "il campo nome è obbligatorio",
	MsgGfehPartitionExists:       "la partizione esiste già",
	MsgGfehPartitionNotFound:     "partizione non trovata",
	MsgGfehNetworkRequired:       "il campo rete è obbligatorio",
	...
	MsgAuditAddGfehPrincipal:     "aggiungi utente di archiviazione a oggetti",
	MsgAuditRemoveGfehPrincipal:  "rimuovi utente di archiviazione a oggetti",
