...
var bnBDMessages = map[string]string{
	...
	MsgAuthSessionNotOwned:          "এই অ্যাকাউন্টটি কেবল নিজের সেশনগুলিই বাতিল করতে পারে",
	...
	MsgGfehNotConfigured:         "অবজেক্ট স্টোরেজ কনফিগার করা নেই",
	MsgGfehNameRequired:          "নাম ক্ষেত্রটি আবশ্যক",
	MsgGfehPartitionExists:       "পার্টিশন ইতিমধ্যে বিদ্যমান",
	MsgGfehPartitionNotFound:     "পার্টিশন পাওয়া যায়নি",
	MsgGfehNetworkRequired:       "নেটওয়ার্ক ক্ষেত্রটি আবশ্যক",
	...
	MsgAuditAddGfehPrincipal:     "অবজেক্ট স্টোরেজ ব্যবহারকারী যোগ",
	MsgAuditRemoveGfehPrincipal:  "অবজেক্ট স্টোরেজ ব্যবহারকারী অপসারণ",
