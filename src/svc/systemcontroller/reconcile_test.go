...
func TestReconcilePagesSubvolumesAndSymlinks(t *testing.T) {
	...
	_, _ = pagesMgr.Create(t.Context(), "alpha-site", "", "", "alpha.example.com", account.PageSourceArchive, "", "", "")
	_, _ = pagesMgr.Create(t.Context(), "beta-site", "", "", "beta.example.com", account.PageSourceArchive, "", "", "")
